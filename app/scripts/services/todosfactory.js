...
//------Variable Declaration     
        var todos = {"nodes":[
                    ...
                    "links": [
                        ...
                        {"id":4,"value":1,"sourceRefId":1,"targetRefId":2, "source":0, "target":0},
                        {"id":5,"value":1,"sourceRefId":5,"targetRefId":9, "source":0, "target":0},
                        {"id":6,"value":1,"sourceRefId":9,"targetRefId":6, "source":0, "target":0},
                        {"id":7,"value":1,"sourceRefId":10,"targetRefId":7, "source":0, "target":0},
                        {"id":8,"value":1,"sourceRefId":11,"targetRefId":8, "source":0, "target":0},
                        {"id":9, "value":1,"sourceRefId":4,"targetRefId":9, "source":0, "target":0},
                        {"id":10,"value":1,"sourceRefId":3,"targetRefId":10, "source":0, "target":0},
                        {"id":11,"value":1,"sourceRefId":2,"targetRefId":11, "source":0, "target":0}
                    ]},
            factory = {};
//......Methods        
        ...
        factory.deleteTodo = function(index, todoList){
            var sourceList = [], targetList = [];
            var tempToDoData = todoList;
            for(var j=0;j<tempToDoData.links.length;j++){
                if (tempToDoData.links[j].sourceRefId == index)
                {
                    targetList[targetList.length] = tempToDoData.links[j].targetRefId;
                    var myindex = tempToDoData.links[j];
                    var mindex = tempToDoData.links.indexOf(myindex);
                    tempToDoData.links.splice(mindex, 1); 
                }
                else if (tempToDoData.links[j].targetRefId == index)
                {
                    sourceList[sourceList.length] = tempToDoData.links[j].sourceRefId;
                    tempToDoData.links.splice(tempToDoData.links.indexOf(tempToDoData.links[j]), 1);
                }
            }
